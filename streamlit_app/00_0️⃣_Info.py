...
st.set_page_config(page_title="Statistics App", page_icon="🧮")
...
### **Analyze Data and Perform Key Statistical Tests**

**The Statistics Calculator app is designed to help users analyze numerical data and conduct essential statistical tests with ease. Built using Python and Streamlit, this app provides intuitive tools for statistical exploration and analysis.**
...
- **Matplotlib** - For visualizing data and test results.
...
2. **Normal Distribution Checker**:
   - Analyze your dataset to determine if it follows a Normal Distribution.
   - Perform statistical tests like the Shapiro-Wilk test.
   - Visualize your data against a theoretical normal curve.

3. **Significance Level Calculator**:
   - Calculate p-values for Z-tests, T-tests, and more.
   - Visualize acceptance and rejection regions.
...
4. **Confidence Interval Calculator**:
   ...
   - Visualize confidence intervals with shaded regions.
...
- Support for uploading and analyzing larger datasets.
- Advanced visualizations for data exploration.

## 🎓 **Motivation**

This project comes after graduating from CCT College in Dublin, Ireland. The goal of this app is to help users understand how statistics work by making abstract concepts more tangible through visualizations. I hope this tool empowers you to explore and learn statistics with ease.
